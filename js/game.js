...
function create() {
  ...
  //ball.body.velocity.set(150, -150); before start button
...
function update() {
  //Example to show how to move the ball
  // ball.x += 1;
  // ball.y += 1;
  ...
  //paddle.x = game.input.x || game.world.width * 0.5; //Paddle position or default position
}
function initBricks() {
  brickInfo = {
    width: 50,
